...
let libro1:Libro = new Libro("1.", "El corazon de hannah", "Joseph Conrad")
console.log(libro1.titulo + ", " + libro1.autor)

// Si quisieramos crear un libro sin tener los datos tendríamos que hacer lo siguiente:
let libto2:Libro = new Libro(null, null, null)

// podemos asignar valores por defecto a los parámetros del constructor
class Alumno {
  nombre: string
  direccion: string
  negativos: number

  constructor(nombre:string = null, direccion: string = null, negativos: number = 0) {
    this.nombre = nombre
